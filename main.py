"""
╔══════════════════════════════════════════════════════════════╗
║     THE CYBER ARC  —  System Monitor Pro  v4.0              ║
║     CPU · RAM · Disk · Network · Email Alerts · Sound       ║
╚══════════════════════════════════════════════════════════════╝
Run:   python system_monitor_pro.py
...
# ═══════════════════════════════════════════════
#  SOUND ENGINE  (stdlib WAV, no extra libs)
# ═══════════════════════════════════════════════
class Sound:
    def __init__(self):
        self.on   = True
...
# ═══════════════════════════════════════════════
#  EMAIL ENGINE  (thread-safe, cooldown, HTML)
# ═══════════════════════════════════════════════
class EmailAlert:
    def __init__(self):
        self.enabled  = False
